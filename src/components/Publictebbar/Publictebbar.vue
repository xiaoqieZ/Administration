<template>
    <div>
        <nav class="mui-bar mui-bar-tab">
			<router-link class="mui-tab-item " to="/Publicone">
				<span class="mui-icon el-icon-s-home" style="width: 30px;height: 26px;"></span>
			...
			<router-link class="mui-tab-item" to="/Publicfore">
				...
				<span class="mui-tab-label" style="font-size: 14px;">我的</span>
			</router-link>
		</nav>
    </div>
</template>
